...
```javascript
isUint8ClampedArray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint8clampedarray@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-uint8clampedarray@v0.2.0-umd/browser.js"></script>
```
